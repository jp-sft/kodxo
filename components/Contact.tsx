      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-kodxo-gray text-lg mb-12">
            Réservez votre Audit Flash Gratuit de 30 minutes
          </p>
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    ...
                    className="bg-kodxo-orange text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-orange-700 transition-all hover:shadow-2xl hover:shadow-orange-600/50 inline-flex items-center justify-center gap-2"
                  >
