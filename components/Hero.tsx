...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-gray-50 to-white">
      ...
      {/* Glow Effect */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-kodxo-orange/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-black text-kodxo-dark mb-6 tracking-tight"
        ...
        >
          ...
          <button
            ...
            className="bg-transparent border-2 border-kodxo-dark/30 text-kodxo-dark px-8 py-4 rounded-lg font-semibold text-lg hover:border-kodxo-dark hover:bg-kodxo-dark/5 transition-all"
          >
